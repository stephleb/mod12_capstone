...
describe("false testing", () => {
  ...
  describe("encode testing", () => {
    it("should encode a message by shifting the letters by the provided shift value", () => {
    ...
    it("the encoded message should include spaces and puncuation as is in the original message", () => {
